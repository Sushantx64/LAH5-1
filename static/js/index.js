...
function setup() {
    ...
    window.addEventListener('scroll', (ev) => {
        if(window.scrollY >= 100){
            document.getElementById("nav").classList.add("navbar-float");
            document.getElementById("goUp").style.opacity = 1;
        }else{
            document.getElementById("nav").classList.remove("navbar-float");
...
function home(){
    ...
    document.getElementById("services-nav").classList.remove("active");
}
function about(){
    window.scroll(0,window.innerHeight-document.getElementById("nav").offsetHeight);
    document.getElementById("home-nav").classList.remove("active");
    document.getElementById("about-nav").classList.add("active");
    document.getElementById("services-nav").classList.remove("active");
}
function services(){
    window.scroll(0,window.innerHeight*2-document.getElementById("nav").offsetHeight);
    document.getElementById("home-nav").classList.remove("active");
    document.getElementById("about-nav").classList.remove("active");
...
document.getElementById("blogLink").addEventListener('click', (ev) => {
    window.location.href = "/blog";
});

particlesJS.load('particle-container', '../others/particles.json');